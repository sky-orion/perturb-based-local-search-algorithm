...
def Computeinsertioncostall(customer, route, instance, selectlist):
    ...
    #         break
    #     subroute = route[i]
    #     insertioncost.append(Computeinsertioncost(customer, subroute, instance))
...
if __name__ == '__main__':
    instance = load_instance(name="p02")
