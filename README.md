...
there have two version of PLS, PLS2 is close to the original expression, PLS1 replaces s with gbest in each iteration, and the performance of PLS1 is slightly better than that of PLS2.  
